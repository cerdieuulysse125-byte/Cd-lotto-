...
export const defaultDB: GlobalDB = {
  proprios: [{id:1,nom:"Proprio Petion-Ville",modpas:"1234",tel:"+509 1234",vendeur:12,statut:"Aktif"}],
  vendeurs: [{id:1,proprioId:1,nom:"Toto",modpas:"1234",pou:"20",statut:"Aktif"}],
  resultats: {},
  limits: { global:5000, proprio:{}, vendeur:{} },
...
export function loadDB(): GlobalDB {
  ...
  try{ return JSON.parse(s); }catch{ return defaultDB; }
}
export function saveDB(db:GlobalDB){ 
