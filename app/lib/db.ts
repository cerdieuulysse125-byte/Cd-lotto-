...
export const defaultDB:GlobalDB={
 proprios:[{id:1,nom:"Proprio Petion-Ville",modpas:"1234",tel:"+509 0000",adr:"Petion-Ville",resp:"Boss",logo:"",statut:"Aktif",msg:""}],
 ...
 fermetures:{"GA midi":"12:15","FL midi":"13:15","NY midi":"14:15","GA soir":"18:15","FL soir":"21:15","NY soir":"22:15"},
 tickets:[], antet:{nom:"C&D VERITE LOTTO",adr:"",tel:"",vendeur:"",logo:"",showDat:true,showTiraj:true,showVande:true,showId:true,pied:"BON CHANS!"}, supModpas:"super123", boulBloke:[]
};
export function loadDB():GlobalDB{
 ...
 try{
  ...
  const p=JSON.parse(s); return {...defaultDB,...p, antet:{...defaultDB.antet,...(p.antet||{})}, limits:{...defaultDB.limits,...(p.limits||{}), global:{...defaultDB.limits.global,...(p.limits?.global||{})}}, prix:{...defaultDB.prix,...(p.prix||{}), global:{...defaultDB.prix.global,...(p.prix?.global||{})}} };
 }catch(e){ localStorage.removeItem(DB_KEY); localStorage.setItem(DB_KEY,JSON.stringify(defaultDB)); return defaultDB; }
}
export function saveDB(db:GlobalDB){ try{ localStorage.setItem(DB_KEY,JSON.stringify(db)); }catch(e){ console.log(e); } }
